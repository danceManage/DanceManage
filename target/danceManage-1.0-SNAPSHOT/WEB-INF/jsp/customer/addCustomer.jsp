...
<body>
<div class="pd-20">
    <form action="/customer/saveCustomer.do" method="post" class="form form-horizontal" id="form-member-add">
        <input type="hidden" id="customerId" name="customerId" value="${customerInfo.id}"/>
        <div class="row cl">
            <label class="form-label col-3"><span class="c-red">*</span>名称：</label>
            <div class="formControls col-5">
                <input type="text" class="input-text" value="${customerInfo.customerName}" placeholder="" id="customerName" name="customerName" datatype="*2-16" nullmsg="名称不能为空">
            </div>
            <div class="col-4"> </div>
        </div>
        <div class="row cl">
            ...
            <div class="formControls col-5">
                <input type="text" class="input-text" value="${customerInfo.customerPhone}" placeholder="" id="customerPhone" name="customerPhone" datatype="*2-16" nullmsg="电话不能为空">
            </div>
            <div class="col-4"> </div>
        </div>
        <div class="row cl">
            ...
            <div class="formControls col-5">
                <textarea rows="4" cols="50" id="customerAddress" name="customerAddress">${customerInfo.customerAddress}</textarea>
            </div>
            <div class="col-4"> </div>
        </div>
        <%--<div class="row cl">
       ...
       <%-- <div class="row cl">
        ...
        <div class="row cl">
            <div class="col-9 col-offset-3">
                <input class="btn btn-primary radius" type="button" onclick="addCustomer();" value="&nbsp;&nbsp;提交&nbsp;&nbsp;">
...
<script type="text/javascript">
    ...
    function addCustomer()
    {
        ...
        $.ajax({
            ...
            dataType:"json",
            type:"POST",
            data:$.toJSON({ customerName: customerName, customerPhone:customerPhone, customerAddress : customerAddress,id:id}),
            success: function(re)
            {
                if(re.ok)
                {
